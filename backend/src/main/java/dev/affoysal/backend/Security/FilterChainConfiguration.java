...
import dev.affoysal.backend.Handler.ApiAccessDeniedHandler;
import dev.affoysal.backend.Handler.ApiAuthenticationEntryPoint;
        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                return http
                                ...
                                .authorizeHttpRequests(request -> request
                                                ...
                                                .hasAnyAuthority("user:d")
                                                .requestMatchers(HttpMethod.DELETE, "/course/delete/**")
                                                .hasAnyAuthority("course:d")
                                                .requestMatchers(HttpMethod.DELETE, "/post/delete/**")
                                                .hasAnyAuthority("post:d")
